function mfn_field_hotspot(field) {
	...
	if( value.length ){
		_.map( value, (obj, i) => {console.log(obj); html += mfn_field_hotspot_render(obj, i) }).join('');
...
function mfn_field_hotspot_render(obj, i) {
	...
	html += `<div class="mfn-hotspot-point-header-left"><a class="mfn-option-btn mfn-option-blank mfn-tab-toggle" href="#"><span class="mfn-icon mfn-icon-arrow-down"></span></a>
			<h6>Point ${i+1}</h6>
			</div>
	...
	html += '</div>';
	html += '<div class="mfn-hotspot-form-wrapper mfn-hotspot-form-wrapper-'+obj.hash+'">';
