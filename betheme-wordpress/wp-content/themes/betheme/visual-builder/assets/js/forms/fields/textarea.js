function mfn_field_textarea(field) {
	...
	if( !data_attr.length ) {
		...
		html += `<div class="form-control has-icon has-icon-right">${dynamic_data}<textarea class="${classes_input.join(' ')}" name="${field.id}" rows="8" placeholder="${placeholder}">${value}</textarea></div>`;
