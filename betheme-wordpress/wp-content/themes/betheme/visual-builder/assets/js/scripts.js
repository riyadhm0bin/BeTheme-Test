    ...
    init: function() {
        ...
        $(document).on('click', '.mfn-hotspot-point .mfn-tab-toggle', function(e) {
            ...
            if( $(this).closest('.mfn-hotspot-point').hasClass('open') ){
                ...
                if( $('style.mfn-fields-switcher-hotospots').length ) $('style.mfn-fields-switcher-hotospots').remove();
            }else{
                ...
                $('body').append('<style class="mfn-builder-fields-css mfn-fields-switcher mfn-fields-switcher-hotospots">.mfn-hotspot-form-'+hash+' .mfn-hotspot-form-wrapper-'+hash+'{ display: block; } .mfn-hotspot-form-'+hash+' .mfn-hotspot-point-tab-header .mfn-tab-toggle{ transform: rotate(180deg); }</style>');
            }
...
var sidebar_form = {
    ...
    open: function($edited_div, scroll = false) {
        ...
        if ( $('body').hasClass('mfn-template-wrap') && $edited_div.hasClass('section') ) return;
        ...
        if( edited_item.jsclass == 'section' ) {
            ...
            if( _.has(edited_item, 'item_is_wrap') || $edited_div.hasClass('mfn-nested-wrap') ) $('.mfn-ui').addClass('mfn-editing-nested-wrap');
        }
        ...
        if( edited_item.jsclass != 'wrap' && edited_item.jsclass != 'section' ) {
            ...
            if( $edited_div.closest('.mcb-wrap').hasClass('mcb-wrap-grid') ) $('.mfn-ui').addClass('mfn-reset-margin-placeholders');
        }
        ...
        if( !sidebar_form.is_class && $edited_div.length && scroll && builder_type !== 'header' ) {
    ...
    render: function() {
        ...
        if( !sidebar_form.is_class ) {
            ...
            if( _.has(edited_item, 'be_classes') && edited_item.be_classes.length && mfn.classes.length && !$edited_div.hasClass('mfn-global-wrap') ) {
                let classes_html = '';
        ...
        if( $edited_div && !$edited_div.hasClass('mfn-looped-items') && ($edited_div.closest('.mfn-looped-items').length || $edited_div.find('.mfn-looped-items').length) ) {
        ...
        /*if( $edited_div && $edited_div.find('.mfn-nested-wrap').length ) {
        ...
        $('.btn-modal-confirm').on('click', function(e){
            ...
            if( $('.mfn-global-section-name').val() != '' ){
                ...
                success: function(response) {
                    ...
                    if( mfn.pagedata.filter((x) => x.uid == GlobalWraps.selectedUid).length ) mfn.pagedata.filter((x) => x.uid == GlobalWraps.selectedUid)[0]['attr']['global_wraps_select'] = response.key;
...
$(document).on('click', '.mfn-checkbox', function(e) {
    ...
    if( opt.hasClass('active') ) {
        ...
        if( opt.closest('.mfn-publication-opt-wrapper').length ) opt.closest('.mfn-publication-opt-wrapper').removeClass('mfn-opt-active'); // popup publication dates
    }else{
        opt.addClass('active');
...
$editpanel.on('click', '.panel-edit-item .row-header.toggled_header', function(e) {
    ...
    if( $('style.mfn-fields-switcher-'+component.attr('data-id')).length ) {
        ...
        $('style.mfn-builder-fields-css:not(.mfn-fields-switcher-normal-hover)').remove();
        $('body').append('<style class="mfn-builder-fields-css mfn-fields-switcher mfn-fields-switcher-'+component.attr('data-id')+'">.mfn-ui .mfn-form .mfn-component-wrapper-'+component.attr('data-id')+' .mfn-form-row.conditionally-show{ display: block; } .mfn-class-editor .mfn-element-fields-wrapper .modalbox-card-style .mfn-component-wrapper-'+component.attr('data-id')+' .mfn-form-row.mfn-class-editor-form-row-visible{display: block;} .mfn-element-fields-wrapper .mfn-component-wrapper-'+component.attr('data-id')+' .mfn-toggled{display: block;} .mfn-element-fields-wrapper .mfn-component-wrapper-'+component.attr('data-id')+' .toggled_header h5:before{ transform: rotate(180deg); color: var(--mfn-ui-heading-arrow-active); }</style>');
    }
});
...
var mfn_label_fields = {
    ...
    init: function() {
        $(document).on('mousedown', '.mfn-form-row.toggle_fields > label > .mfn-vb-label-button', function(e) {
            ...
            mfn_label_fields.id = box.attr('class');
            mfn_label_fields.class = mfn_label_fields.id.replaceAll(' ', '.');

            initFontSelect(box);

            $('body').append('<style class="mfn-builder-fields-css mfn-builder-label-fields mfn-builder-fields-css-'+ mfn_label_fields.id.replaceAll(' ', '')+'">.mfn-ui .mfn-form .'+mfn_label_fields.class+' > label .mfn-vb-label-button {background-color: #72a5d8;} .mfn-ui .mfn-form .'+mfn_label_fields.class+' > label .mfn-vb-label-button .mfn-icon-edit { background-image: url('+mfn.themepath+'/visual-builder/assets/svg/options/edit-light.svg); }.mfn-ui .mfn-form .'+mfn_label_fields.class+' .mfn-toggle-fields-wrapper{display: block;}</style>');
            $('.sidebar-wrapper').addClass('mfn-vb-sidebar-overlay');
    ...
    hide: function(e) {
        var div = $('.mfn-element-fields-wrapper .'+ mfn_label_fields.class+' .mfn-toggle-fields-wrapper');
        var tools_switcher = $('.mfn-element-fields-wrapper .'+ mfn_label_fields.class+' .mfn-vb-label-button');
...
$editpanel.on('click', '.panel-edit-item ul.sidebar-panel-content-tabs > li', function(e) {
    ...
    if( !$(this).hasClass('active') ) {
        ...
        if( $(this).hasClass('spct-li-advanced') || $(this).hasClass('spct-li-style') ){
            let fid = $('.mfn-element-fields-wrapper .modalbox-card.modalbox-card-'+tab+' .mfn-component-wrapper:first-child').attr('data-id');
            if( $('.mfn-element-fields-wrapper .modalbox-card.modalbox-card-'+tab+' .mfn-component-wrapper').length ){
                if( !$('style.mfn-fields-switcher-'+fid).length ){
                    $('.mfn-element-fields-wrapper .modalbox-card.modalbox-card-'+tab+' .mfn-component-wrapper:first-child .toggled_header').trigger('click');
                }
            }
        }
  ...
  showhidefields: function(formrow) {
    ...
    if (Array.isArray(mfnoptsinputs.condition)) {
        ...
        mfnoptsinputs.condition.map( (c) => {
            ...
            if( $('#'+c.id+'.mfn-form-row .single-segmented-option.segmented-options').length || $('#'+c.id+'.mfn-form-row .visual-options').length ) {
                val = $('#'+c.id+'.mfn-form-row input:checked').val();
            }else{
                val = $('#'+c.id+'.mfn-form-row .mfn-field-value, .condition-field, .field-to-object').val();
            }
        ...
        //console.log({'cond': mfnoptsinputs.condition, 'rel': mfnoptsinputs.relation, 'show': show});
        ...
        if( $('#'+mfnoptsinputs.condition.id+'.mfn-form-row .single-segmented-option.segmented-options').length || $('#'+mfnoptsinputs.condition.id+'.mfn-form-row .visual-options').length ){
...
function updateObject( $field ){
    ...
    var val = $field.attr('type') == 'checkbox' && !$field.prop('checked') ? '' : $field.val(); // checkbox unclickable
    ...
    if( $field.closest('.typography').length && typeof $field.attr('data-key') !== 'undefined' ){
        ...
        if( edited_item['attr']['hotspots'].filter(item => item.hash == point_hash ).length ) {

            let ht = edited_item['attr']['hotspots'].filter(item => item.hash == point_hash )[0];
            ...
            if( field_name.includes('css_') ) {
                ...
                if( _.has(ht['val'], field_name) ) {
                    if( $editrow.hasClass('mfn_field_rwd') ){
                        ht['val'][field_name]['val'][screen] = $field.val();
                    }else{
                        ht['val'][field_name]['val'] = $field.val();
                    }
                }else{
                    var tmp_val = {};
                ...
                if( $field.closest('.mfn-form-row').hasClass('mfn_field_rwd') ){
                    ...
                    ht[field_name][screen] = $field.val();
                }else{
                    ht[field_name] = $field.val();
                }
    ...
    setTimeout( function() {
        ...
        if( ($field.val().length && $field.val().includes('{')) ) {
            ...
            if( $content.find('.'+it).closest('.mfn-looped-items').length || $content.find('.'+it).find('.mfn-looped-items').length ) {
